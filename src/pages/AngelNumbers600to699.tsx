...
const AngelNumbers600to699: React.FC = () => {
    ...
    <>
      ...
      <div className="container mx-auto px-4 py-8">
        <h1 className="text-3xl md:text-4xl font-bold text-center mb-6">
          Numerele Angelice de la 600 la 699
        </h1>
        <p className="text-lg text-center text-gray-600 mb-8 max-w-3xl mx-auto">
          Descoperă semnificația numerelor angelice de la 600 la 699. Fiecare număr poartă un mesaj unic de la îngerii păzitori.
        </p>
        ...
        <div className="max-w-2xl mx-auto mb-12 bg-white rounded-lg shadow-md p-6">
          ...
          <form onSubmit={handleSearch} className="flex gap-2">
            <input
              ...
              placeholder="Introdu un număr între 600 și 699"
            ...
            <div>
              ...
              <div className="space-y-2">
                <div className="flex items-center">
                  ...
                  <span className="text-sm">Numere Master (611, 622, 633)</span>
                </div>
                <div className="flex items-center">
                  <div className="w-4 h-4 rounded-full bg-blue-500 mr-2"></div>
                  <span className="text-sm">Numere Speciale (600, 610, 620)</span>
                </div>
                <div className="flex items-center">
                  <div className="w-4 h-4 rounded-full bg-green-500 mr-2"></div>
                  <span className="text-sm">Numere Puternice (603, 612, 621)</span>
                </div>
                <div className="flex items-center">
                  <div className="w-4 h-4 rounded-full bg-pink-500 mr-2"></div>
                  <span className="text-sm">Numere Oglindă (601, 611, 621)</span>
                </div>
                <div className="flex items-center">
            ...
            {frequentNumbers.map(({ number, category, icon: Icon, color }) => (
              ...
              >
                ...
                <p className="text-sm opacity-80">
                  {number === 666 && "Număr master de spiritualitate și intuiție"}
                  {number === 678 && "Număr secvențial de progres și evoluție"}
                  {number === 690 && "Număr de abundență și prosperitate"}
                  {number === 699 && "Număr de schimbare și transformare"}
                  {number === 611 && "Număr de dragoste și armonie"}
                  {number === 622 && "Număr de înțelepciune și claritate spirituală"}
                  {number === 633 && "Număr de abundență materială și spirituală"}
                  {number === 644 && "Număr de completare și finalizare"}
                </p>
        ...
        <div className="mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="bg-white p-6 rounded-xl shadow-md border border-purple-100">
              ...
              <div className="flex flex-wrap gap-2 mb-4">
                <Link 
                  to="/semnificatia-numarului-angelic-601" 
                  className="px-3 py-1 bg-purple-100 text-purple-700 rounded-full text-sm font-medium hover:bg-purple-200 transition-colors"
                >
                  601
                </Link>
                ...
                <Link 
                  to="/semnificatia-numarului-angelic-621" 
                  className="px-3 py-1 bg-purple-100 text-purple-700 rounded-full text-sm font-medium hover:bg-purple-200 transition-colors"
                >
                  621
                </Link>
            ...
            <div className="bg-white p-6 rounded-xl shadow-md border border-purple-100">
              ...
              <div className="flex flex-wrap gap-2 mb-4">
                <Link 
                  to="/semnificatia-numarului-angelic-631" 
                  className="px-3 py-1 bg-purple-100 text-purple-700 rounded-full text-sm font-medium hover:bg-purple-200 transition-colors"
                >
                  631
                </Link>
                <Link 
                  to="/semnificatia-numarului-angelic-641" 
                  className="px-3 py-1 bg-purple-100 text-purple-700 rounded-full text-sm font-medium hover:bg-purple-200 transition-colors"
                >
                  641
                </Link>
                <Link 
                  to="/semnificatia-numarului-angelic-651" 
                  className="px-3 py-1 bg-purple-100 text-purple-700 rounded-full text-sm font-medium hover:bg-purple-200 transition-colors"
                >
                  651
                </Link>
            ...
            <div className="bg-white p-6 rounded-xl shadow-md border border-purple-100">
              ...
              <div className="flex flex-wrap gap-2 mb-4">
                <Link 
                  to="/semnificatia-numarului-angelic-661" 
                  className="px-3 py-1 bg-purple-100 text-purple-700 rounded-full text-sm font-medium hover:bg-purple-200 transition-colors"
                >
                  661
                </Link>
                <Link 
                  to="/semnificatia-numarului-angelic-671" 
                  className="px-3 py-1 bg-purple-100 text-purple-700 rounded-full text-sm font-medium hover:bg-purple-200 transition-colors"
                >
                  671
                </Link>
                <Link 
                  to="/semnificatia-numarului-angelic-681" 
                  className="px-3 py-1 bg-purple-100 text-purple-700 rounded-full text-sm font-medium hover:bg-purple-200 transition-colors"
                >
                  681
                </Link>
