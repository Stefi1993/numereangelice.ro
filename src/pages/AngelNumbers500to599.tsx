...
const AngelNumbers500to599: React.FC = () => {
    ...
    <>
      ...
      <div className="container mx-auto px-4 py-8">
        <h1 className="text-3xl md:text-4xl font-bold text-center mb-6">
          Numerele Angelice de la 500 la 599
        </h1>
        <p className="text-lg text-center text-gray-600 mb-8 max-w-3xl mx-auto">
          Descoperă semnificația numerelor angelice de la 500 la 599. Fiecare număr poartă un mesaj unic de la îngerii păzitori.
        </p>
        ...
        <div className="max-w-2xl mx-auto mb-12 bg-white rounded-lg shadow-md p-6">
          ...
          <form onSubmit={handleSearch} className="flex gap-2">
            <input
              ...
              placeholder="Introdu un număr între 500 și 599"
            ...
            <div>
              ...
              <div className="space-y-2">
                <div className="flex items-center">
                  ...
                  <span className="text-sm">Numere Master (555, 566, 577)</span>
                </div>
                <div className="flex items-center">
                  <div className="w-4 h-4 rounded-full bg-blue-500 mr-2"></div>
                  <span className="text-sm">Numere Speciale (500, 510, 520)</span>
                </div>
                <div className="flex items-center">
                  <div className="w-4 h-4 rounded-full bg-green-500 mr-2"></div>
                  <span className="text-sm">Numere Puternice (504, 513, 522)</span>
                </div>
                <div className="flex items-center">
                  <div className="w-4 h-4 rounded-full bg-pink-500 mr-2"></div>
                  <span className="text-sm">Numere Oglindă (501, 511, 521)</span>
                </div>
                <div className="flex items-center">
            ...
            {frequentNumbers.map(({ number, category, icon: Icon, color }) => (
              ...
              >
                ...
                <p className="text-sm opacity-80">
                  {number === 555 && "Număr master de spiritualitate și intuiție"}
                  {number === 567 && "Număr secvențial de progres și evoluție"}
                  {number === 579 && "Număr de abundență și prosperitate"}
                  {number === 588 && "Număr de schimbare și transformare"}
                  {number === 599 && "Număr de dragoste și armonie"}
                  {number === 522 && "Număr de înțelepciune și claritate spirituală"}
                  {number === 533 && "Număr de abundență materială și spirituală"}
                  {number === 544 && "Număr de completare și finalizare"}
                </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-white p-6 rounded-xl shadow-md border border-purple-100">
              ...
              <div className="flex flex-wrap gap-2 mb-4">
                ...
                <Link 
                  to="/semnificatia-numarului-angelic-566" 
                  className="px-3 py-1 bg-purple-100 text-purple-700 rounded-full text-sm font-medium hover:bg-purple-200 transition-colors"
                >
                  566
                </Link>
                <Link 
                  to="/semnificatia-numarului-angelic-577" 
                  className="px-3 py-1 bg-purple-100 text-purple-700 rounded-full text-sm font-medium hover:bg-purple-200 transition-colors"
                >
                  577
                </Link>
            ...
            <div className="bg-white p-6 rounded-xl shadow-md border border-purple-100">
              ...
              <div className="flex flex-wrap gap-2 mb-4">
                <Link 
                  to="/semnificatia-numarului-angelic-501" 
                  className="px-3 py-1 bg-purple-100 text-purple-700 rounded-full text-sm font-medium hover:bg-purple-200 transition-colors"
                >
                  501
                </Link>
                <Link 
                  to="/semnificatia-numarului-angelic-511" 
                  className="px-3 py-1 bg-purple-100 text-purple-700 rounded-full text-sm font-medium hover:bg-purple-200 transition-colors"
                >
                  511
                </Link>
                <Link 
                  to="/semnificatia-numarului-angelic-521" 
                  className="px-3 py-1 bg-purple-100 text-purple-700 rounded-full text-sm font-medium hover:bg-purple-200 transition-colors"
                >
                  521
                </Link>
            ...
            <div className="bg-white p-6 rounded-xl shadow-md border border-purple-100">
              ...
              <div className="flex flex-wrap gap-2 mb-4">
                <Link 
                  to="/semnificatia-numarului-angelic-531" 
                  className="px-3 py-1 bg-purple-100 text-purple-700 rounded-full text-sm font-medium hover:bg-purple-200 transition-colors"
                >
                  531
                </Link>
                <Link 
                  to="/semnificatia-numarului-angelic-541" 
                  className="px-3 py-1 bg-purple-100 text-purple-700 rounded-full text-sm font-medium hover:bg-purple-200 transition-colors"
                >
                  541
                </Link>
                <Link 
                  to="/semnificatia-numarului-angelic-551" 
                  className="px-3 py-1 bg-purple-100 text-purple-700 rounded-full text-sm font-medium hover:bg-purple-200 transition-colors"
                >
                  551
                </Link>
            ...
            <div className="bg-white p-6 rounded-xl shadow-md border border-purple-100">
              ...
              <div className="flex flex-wrap gap-2 mb-4">
                <Link 
                  to="/semnificatia-numarului-angelic-561" 
                  className="px-3 py-1 bg-purple-100 text-purple-700 rounded-full text-sm font-medium hover:bg-purple-200 transition-colors"
                >
                  561
                </Link>
                <Link 
                  to="/semnificatia-numarului-angelic-571" 
                  className="px-3 py-1 bg-purple-100 text-purple-700 rounded-full text-sm font-medium hover:bg-purple-200 transition-colors"
                >
                  571
                </Link>
                <Link 
                  to="/semnificatia-numarului-angelic-581" 
                  className="px-3 py-1 bg-purple-100 text-purple-700 rounded-full text-sm font-medium hover:bg-purple-200 transition-colors"
                >
                  581
                </Link>
