...
const AngelNumbers900to999: React.FC = () => {
    ...
    <>
      ...
      <div className="container mx-auto px-4 py-8">
        <h1 className="text-3xl md:text-4xl font-bold text-center mb-6">
          Numerele Angelice de la 900 la 999
        </h1>
        <p className="text-lg text-center text-gray-600 mb-8 max-w-3xl mx-auto">
          Descoperă semnificația numerelor angelice de la 900 la 999. Fiecare număr poartă un mesaj unic de la îngerii păzitori.
        </p>
        ...
        <div className="max-w-2xl mx-auto mb-12 bg-white rounded-lg shadow-md p-6">
          ...
          <form onSubmit={handleSearch} className="flex gap-2">
            <input
              ...
              placeholder="Introdu un număr între 900 și 999"
            ...
            <div>
              ...
              <div className="space-y-2">
                <div className="flex items-center">
                  ...
                  <span className="text-sm">Numere Master (911, 922, 933)</span>
                </div>
                <div className="flex items-center">
                  <div className="w-4 h-4 rounded-full bg-blue-500 mr-2"></div>
                  <span className="text-sm">Numere Speciale (900, 910, 920)</span>
                </div>
                <div className="flex items-center">
                  <div className="w-4 h-4 rounded-full bg-green-500 mr-2"></div>
                  <span className="text-sm">Numere Puternice (908, 917, 926)</span>
                </div>
                <div className="flex items-center">
                  <div className="w-4 h-4 rounded-full bg-pink-500 mr-2"></div>
                  <span className="text-sm">Numere Oglindă (901, 911, 921)</span>
                </div>
                <div className="flex items-center">
            ...
            {frequentNumbers.map(({ number, category, icon: Icon, color }) => (
              ...
              >
                ...
                <p className="text-sm opacity-80">
                  {number === 911 && "Număr master de spiritualitate și intuiție"}
                  {number === 922 && "Număr secvențial de progres și evoluție"}
                  {number === 933 && "Număr de abundență și prosperitate"}
                  {number === 944 && "Număr de schimbare și transformare"}
                  {number === 955 && "Număr de dragoste și armonie"}
                  {number === 966 && "Număr de înțelepciune și claritate spirituală"}
                  {number === 977 && "Număr de abundență materială și spirituală"}
                  {number === 988 && "Număr de completare și finalizare"}
                </p>
        ...
        <div className="mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="bg-white p-6 rounded-xl shadow-md border border-purple-100">
              ...
              <div className="flex flex-wrap gap-2 mb-4">
                <Link 
                  to="/semnificatia-numarului-angelic-901" 
                  className="px-3 py-1 bg-purple-100 text-purple-700 rounded-full text-sm font-medium hover:bg-purple-200 transition-colors"
                >
                  901
                </Link>
                ...
                <Link 
                  to="/semnificatia-numarului-angelic-921" 
                  className="px-3 py-1 bg-purple-100 text-purple-700 rounded-full text-sm font-medium hover:bg-purple-200 transition-colors"
                >
                  921
                </Link>
            ...
            <div className="bg-white p-6 rounded-xl shadow-md border border-purple-100">
              ...
              <div className="flex flex-wrap gap-2 mb-4">
                <Link 
                  to="/semnificatia-numarului-angelic-931" 
                  className="px-3 py-1 bg-purple-100 text-purple-700 rounded-full text-sm font-medium hover:bg-purple-200 transition-colors"
                >
                  931
                </Link>
                <Link 
                  to="/semnificatia-numarului-angelic-941" 
                  className="px-3 py-1 bg-purple-100 text-purple-700 rounded-full text-sm font-medium hover:bg-purple-200 transition-colors"
                >
                  941
                </Link>
                <Link 
                  to="/semnificatia-numarului-angelic-951" 
                  className="px-3 py-1 bg-purple-100 text-purple-700 rounded-full text-sm font-medium hover:bg-purple-200 transition-colors"
                >
                  951
                </Link>
            ...
            <div className="bg-white p-6 rounded-xl shadow-md border border-purple-100">
              ...
              <div className="flex flex-wrap gap-2 mb-4">
                <Link 
                  to="/semnificatia-numarului-angelic-961" 
                  className="px-3 py-1 bg-purple-100 text-purple-700 rounded-full text-sm font-medium hover:bg-purple-200 transition-colors"
                >
                  961
                </Link>
                <Link 
                  to="/semnificatia-numarului-angelic-971" 
                  className="px-3 py-1 bg-purple-100 text-purple-700 rounded-full text-sm font-medium hover:bg-purple-200 transition-colors"
                >
                  971
                </Link>
                <Link 
                  to="/semnificatia-numarului-angelic-981" 
                  className="px-3 py-1 bg-purple-100 text-purple-700 rounded-full text-sm font-medium hover:bg-purple-200 transition-colors"
                >
                  981
                </Link>
