...
const AngelNumbers700to799: React.FC = () => {
    ...
    <>
      ...
      <div className="container mx-auto px-4 py-8">
        <h1 className="text-3xl md:text-4xl font-bold text-center mb-6">
          Numerele Angelice de la 700 la 799
        </h1>
        <p className="text-lg text-center text-gray-600 mb-8 max-w-3xl mx-auto">
          Descoperă semnificația numerelor angelice de la 700 la 799. Fiecare număr poartă un mesaj unic de la îngerii păzitori.
        </p>
        ...
        <div className="max-w-2xl mx-auto mb-12 bg-white rounded-lg shadow-md p-6">
          ...
          <form onSubmit={handleSearch} className="flex gap-2">
            <input
              ...
              placeholder="Introdu un număr între 700 și 799"
            ...
            <div>
              ...
              <div className="space-y-2">
                <div className="flex items-center">
                  ...
                  <span className="text-sm">Numere Master (711, 722, 733)</span>
                </div>
                <div className="flex items-center">
                  <div className="w-4 h-4 rounded-full bg-blue-500 mr-2"></div>
                  <span className="text-sm">Numere Speciale (700, 710, 720)</span>
                </div>
                <div className="flex items-center">
                  <div className="w-4 h-4 rounded-full bg-green-500 mr-2"></div>
                  <span className="text-sm">Numere Puternice (708, 717, 726)</span>
                </div>
                <div className="flex items-center">
                  <div className="w-4 h-4 rounded-full bg-pink-500 mr-2"></div>
                  <span className="text-sm">Numere Oglindă (701, 711, 721)</span>
                </div>
                <div className="flex items-center">
            ...
            {frequentNumbers.map(({ number, category, icon: Icon, color }) => (
              ...
              >
                ...
                <p className="text-sm opacity-80">
                  {number === 711 && "Număr master de spiritualitate și intuiție"}
                  {number === 722 && "Număr secvențial de progres și evoluție"}
                  {number === 733 && "Număr de abundență și prosperitate"}
                  {number === 744 && "Număr de schimbare și transformare"}
                  {number === 755 && "Număr de dragoste și armonie"}
                  {number === 766 && "Număr de înțelepciune și claritate spirituală"}
                  {number === 777 && "Număr de abundență materială și spirituală"}
                  {number === 788 && "Număr de completare și finalizare"}
                </p>
        ...
        <div className="mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="bg-white p-6 rounded-xl shadow-md border border-purple-100">
              ...
              <div className="flex flex-wrap gap-2 mb-4">
                <Link 
                  to="/semnificatia-numarului-angelic-701" 
                  className="px-3 py-1 bg-purple-100 text-purple-700 rounded-full text-sm font-medium hover:bg-purple-200 transition-colors"
                >
                  701
                </Link>
                ...
                <Link 
                  to="/semnificatia-numarului-angelic-721" 
                  className="px-3 py-1 bg-purple-100 text-purple-700 rounded-full text-sm font-medium hover:bg-purple-200 transition-colors"
                >
                  721
                </Link>
            ...
            <div className="bg-white p-6 rounded-xl shadow-md border border-purple-100">
              ...
              <div className="flex flex-wrap gap-2 mb-4">
                <Link 
                  to="/semnificatia-numarului-angelic-731" 
                  className="px-3 py-1 bg-purple-100 text-purple-700 rounded-full text-sm font-medium hover:bg-purple-200 transition-colors"
                >
                  731
                </Link>
                <Link 
                  to="/semnificatia-numarului-angelic-741" 
                  className="px-3 py-1 bg-purple-100 text-purple-700 rounded-full text-sm font-medium hover:bg-purple-200 transition-colors"
                >
                  741
                </Link>
                <Link 
                  to="/semnificatia-numarului-angelic-751" 
                  className="px-3 py-1 bg-purple-100 text-purple-700 rounded-full text-sm font-medium hover:bg-purple-200 transition-colors"
                >
                  751
                </Link>
            ...
            <div className="bg-white p-6 rounded-xl shadow-md border border-purple-100">
              ...
              <div className="flex flex-wrap gap-2 mb-4">
                <Link 
                  to="/semnificatia-numarului-angelic-761" 
                  className="px-3 py-1 bg-purple-100 text-purple-700 rounded-full text-sm font-medium hover:bg-purple-200 transition-colors"
                >
                  761
                </Link>
                <Link 
                  to="/semnificatia-numarului-angelic-771" 
                  className="px-3 py-1 bg-purple-100 text-purple-700 rounded-full text-sm font-medium hover:bg-purple-200 transition-colors"
                >
                  771
                </Link>
                <Link 
                  to="/semnificatia-numarului-angelic-781" 
                  className="px-3 py-1 bg-purple-100 text-purple-700 rounded-full text-sm font-medium hover:bg-purple-200 transition-colors"
                >
                  781
                </Link>
