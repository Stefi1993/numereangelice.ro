...
const AngelNumbers400to499: React.FC = () => {
    ...
    <>
      ...
      <div className="container mx-auto px-4 py-8">
        <h1 className="text-3xl md:text-4xl font-bold text-center mb-6">
          Numerele Angelice de la 400 la 499
        </h1>
        <p className="text-lg text-center text-gray-600 mb-8 max-w-3xl mx-auto">
          Descoperă semnificația numerelor angelice de la 400 la 499. Fiecare număr poartă un mesaj unic de la îngerii păzitori.
        </p>
        ...
        <div className="max-w-2xl mx-auto mb-12 bg-white rounded-lg shadow-md p-6">
          ...
          <form onSubmit={handleSearch} className="flex gap-2">
            <input
              ...
              placeholder="Introdu un număr între 400 și 499"
            ...
            <div>
              ...
              <div className="space-y-2">
                <div className="flex items-center">
                  ...
                  <span className="text-sm">Numere Master (444, 455, 466)</span>
                </div>
                <div className="flex items-center">
                  <div className="w-4 h-4 rounded-full bg-blue-500 mr-2"></div>
                  <span className="text-sm">Numere Speciale (400, 410, 420)</span>
                </div>
                <div className="flex items-center">
                  <div className="w-4 h-4 rounded-full bg-green-500 mr-2"></div>
                  <span className="text-sm">Numere Puternice (405, 414, 423)</span>
                </div>
                <div className="flex items-center">
                  <div className="w-4 h-4 rounded-full bg-pink-500 mr-2"></div>
                  <span className="text-sm">Numere Oglindă (401, 411, 421)</span>
                </div>
                <div className="flex items-center">
            ...
            {frequentNumbers.map(({ number, category, icon: Icon, color }) => (
              ...
              >
                ...
                <p className="text-sm opacity-80">
                  {number === 444 && "Număr master de spiritualitate și intuiție"}
                  {number === 456 && "Număr secvențial de progres și evoluție"}
                  {number === 468 && "Număr de abundență și prosperitate"}
                  {number === 477 && "Număr de schimbare și transformare"}
                  {number === 488 && "Număr de dragoste și armonie"}
                  {number === 499 && "Număr de înțelepciune și claritate spirituală"}
                  {number === 422 && "Număr de abundență materială și spirituală"}
                  {number === 433 && "Număr de completare și finalizare"}
                </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-white p-6 rounded-xl shadow-md border border-purple-100">
              ...
              <div className="flex flex-wrap gap-2 mb-4">
                ...
                <Link 
                  to="/semnificatia-numarului-angelic-455" 
                  className="px-3 py-1 bg-purple-100 text-purple-700 rounded-full text-sm font-medium hover:bg-purple-200 transition-colors"
                >
                  455
                </Link>
                <Link 
                  to="/semnificatia-numarului-angelic-466" 
                  className="px-3 py-1 bg-purple-100 text-purple-700 rounded-full text-sm font-medium hover:bg-purple-200 transition-colors"
                >
                  466
                </Link>
            ...
            <div className="bg-white p-6 rounded-xl shadow-md border border-purple-100">
              ...
              <div className="flex flex-wrap gap-2 mb-4">
                <Link 
                  to="/semnificatia-numarului-angelic-401" 
                  className="px-3 py-1 bg-purple-100 text-purple-700 rounded-full text-sm font-medium hover:bg-purple-200 transition-colors"
                >
                  401
                </Link>
                <Link 
                  to="/semnificatia-numarului-angelic-411" 
                  className="px-3 py-1 bg-purple-100 text-purple-700 rounded-full text-sm font-medium hover:bg-purple-200 transition-colors"
                >
                  411
                </Link>
                <Link 
                  to="/semnificatia-numarului-angelic-421" 
                  className="px-3 py-1 bg-purple-100 text-purple-700 rounded-full text-sm font-medium hover:bg-purple-200 transition-colors"
                >
                  421
                </Link>
            ...
            <div className="bg-white p-6 rounded-xl shadow-md border border-purple-100">
              ...
              <div className="flex flex-wrap gap-2 mb-4">
                <Link 
                  to="/semnificatia-numarului-angelic-431" 
                  className="px-3 py-1 bg-purple-100 text-purple-700 rounded-full text-sm font-medium hover:bg-purple-200 transition-colors"
                >
                  431
                </Link>
                <Link 
                  to="/semnificatia-numarului-angelic-441" 
                  className="px-3 py-1 bg-purple-100 text-purple-700 rounded-full text-sm font-medium hover:bg-purple-200 transition-colors"
                >
                  441
                </Link>
                <Link 
                  to="/semnificatia-numarului-angelic-451" 
                  className="px-3 py-1 bg-purple-100 text-purple-700 rounded-full text-sm font-medium hover:bg-purple-200 transition-colors"
                >
                  451
                </Link>
            ...
            <div className="bg-white p-6 rounded-xl shadow-md border border-purple-100">
              ...
              <div className="flex flex-wrap gap-2 mb-4">
                <Link 
                  to="/semnificatia-numarului-angelic-461" 
                  className="px-3 py-1 bg-purple-100 text-purple-700 rounded-full text-sm font-medium hover:bg-purple-200 transition-colors"
                >
                  461
                </Link>
                <Link 
                  to="/semnificatia-numarului-angelic-471" 
                  className="px-3 py-1 bg-purple-100 text-purple-700 rounded-full text-sm font-medium hover:bg-purple-200 transition-colors"
                >
                  471
                </Link>
                <Link 
                  to="/semnificatia-numarului-angelic-481" 
                  className="px-3 py-1 bg-purple-100 text-purple-700 rounded-full text-sm font-medium hover:bg-purple-200 transition-colors"
                >
                  481
                </Link>
